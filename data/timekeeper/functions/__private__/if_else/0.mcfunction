...
tellraw @a ["",{"text":"[Timekeeper] ","bold":true},{"text":"Average MSPT over ","color":"aqua"},{"score":{"name":"$length","objective":"timekeeper.var"},"color":"aqua"},{"text":" ticks:","color":"aqua"},{"text":" "},{"nbt":"text","interpret":true,"storage":"timekeeper:storage"}]
